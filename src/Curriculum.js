    ...
    return (
        <div>
           ...
           <h5 className="csubtopics m-4">INTRODUCTION</h5>
            <img className="cimg" src="./assects/cirriculum1.png"  alt=""/>
            ...
            <img className="cimg" src="./assects/cirriculum2.png" alt="" />
            ...
            <img className="cimg" src="./assects/cirriculum3.png" alt="" />
            <p className="ptext">Exploratory Data Analysis Normal Distribution Skewness & Kurtosis 5 Point Summary Analysis
            </p>
            <h5 className="csubtopics m-4">BRIDGE COURSE</h5>
            <img className="cimg" src="./assects/cirriculum4.png" alt="" />
            ...
            <img className="cimg" src="./assects/cirriculum5.png" alt="" />
